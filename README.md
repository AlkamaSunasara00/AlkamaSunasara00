...
I enjoy designing clean UIs, smooth dashboards, and scalable backends that solve real problems for real users.
...
- 🍰 **Bakery Website (Live)** – Sheetal Sweets & Bakery  
- 🛒 **E-Commerce Platform**  
- 🗂️ **Portfolio with Animated Tabs & Tech Filters**  
- 🪡 **TailorConnect** – state → city → nearby tailor finder  
...
- 🔐 Backend security & clean architecture  
